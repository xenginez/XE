...
public:
	constexpr ObjectAllocator() noexcept
	{
	}
	...
	template<class _Other> constexpr ObjectAllocator( const ObjectAllocator<_Other> & ) noexcept
	{
	}
...
public:
	...
	bool operator==( const XE::ObjectAllocator<_Other> & ) noexcept
	{
		return ( true );
	}
