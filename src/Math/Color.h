...
public:
	...
	FColor( XE::real r, XE::real g, XE::real b, XE::real a = 1.0f );
...
public:
	...
	FColor operator *( XE::real val ) const;
...
public:
	friend FColor operator *( XE::real a, const FColor& b );
...
public:
	static FColor Lerp( const FColor& val1, const FColor& val2, XE::real val );
};
