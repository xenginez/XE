...
DECL_EVENT( KEY_UP, u8"键盘按键抬起", XE::uint32 );
DECL_EVENT( KEY_DOWN, u8"键盘按键按下", XE::uint32 );
DECL_EVENT( MOUSE_UP, u8"鼠标按键抬起", XE::uint32 );
DECL_EVENT( MOUSE_DOWN, u8"鼠标按键按下", XE::uint32 );
