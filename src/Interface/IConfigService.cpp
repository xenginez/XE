...
bool IConfigService::GetBool( const String & key, bool def )
{
...
XE::int8 IConfigService::GetInt8( const String & key, XE::int8 def )
{
	String s = GetValue( key );
...
XE::int16 IConfigService::GetInt16( const String & key, XE::int16 def )
{
	String s = GetValue( key );
...
XE::int32 IConfigService::GetInt32( const String & key, XE::int32 def )
{
	String s = GetValue( key );
...
XE::int64 IConfigService::GetInt64( const String & key, XE::int64 def )
{
	String s = GetValue( key );
...
XE::uint8 IConfigService::GetUInt8( const String & key, XE::uint8 def )
{
	String s = GetValue( key );
...
XE::uint16 IConfigService::GetUInt16( const String & key, XE::uint16 def )
{
	String s = GetValue( key );
...
XE::uint32 IConfigService::GetUInt32( const String & key, XE::uint32 def )
{
	String s = GetValue( key );
...
XE::uint64 IConfigService::GetUInt64( const String & key, XE::uint64 def )
{
	String s = GetValue( key );
...
XE::float32 IConfigService::GetFloat32( const String & key, XE::float32 def )
{
	String s = GetValue( key );
...
XE::float64 IConfigService::GetFloat64( const String & key, XE::float64 def )
{
	String s = GetValue( key );
...
String IConfigService::GetString( const String & key, const String & def )
{
	String s = GetValue( key );
